...
let index_lang = {
    ...
    "section_one": {
        "header": {
            "en": "Saving good users from fraudsters with cutting-edge technology",
    ...
    "section_two": {
        "header": {
            "en": "Product Security without Tradeoffs",
        ...
        "conversion": {
            ...
            "de": "In dem Sie eine Option für Card Scan zu Ihrer Applikation hinzufügen, verbessern sie Zahlungsumwandlung bis zu 5%. Card Scan ist schneller und bietet mehr Flexibilität als andere Lösungen die sich im Markt befinden."
        },
        "intuitive": {
            "en": "Bouncer is something different: flows that add security while reducing churn. We do it by packing a lot of intelligence behind the flow, and by obesessing over the user experience in every interaction we design.",
            "de": "Bouncer bietet etwas anderes: Ihre Programme werden sicherer und User arbeiten weniger. Wir haben sehr viel Arbeit in User Erfahrung investiert und jedes Teil sorgfältig entworfen."
        }
    },
    "section_three": {
        "header": {
            "en": "Add extra security with Card Verify",
            "de": "Füge mit Card Verify Sicherheit hinzu"
        },
        "paragraph": {
        ...
        "list_item_one": {
            ...
            "de": "Raffinierte Bildanalyse findet gefälschte Karten"
        },
        "list_item_two": {
            "en": "Real-time verification in your app",
            "de": "Echtzeit Nachprüfung in eurer Applikation"
        },
        "list_item_three": {
            "en": "Detects emulators, jail broken phones, and bots",
            "de": "Findet Emulatoren, Telefone mit Jailbreak und bots"
        }
    },
    "section_four": {
        "soon": {
        ...
        "header": {
            ...
            "de": "Schnell und sicher können Sie Lichtbildausweise scannen, mit ID Scan"
        },
        "paragraph": {
    ...
    "section_five": {
        "header": {
            "en": "Founded From Experience",
            "de": "Gegründet aus Erfahrung"
        },
        "paragraph": {
        ...
        "tile_one": {
            ...
            "de": "Mit-begründer und CEO"
        },
        "tile_two": {
            "en": "Co-founder and Chief Scientist",
            "de": "Mit-begründer und Hauptwissenschaftler"
        },
        "tile_three": {
            "en": "Co-founder",
            "de": "Mit-begründer"
    ...
    "section_six": {
        ...
        "community": {
            "en": "Join Community",
            "de": "Gemeinschaft zutreten"
        }
    }
}

export default index_lang